...
<form action="array_nangcao.php" method="post" >
    <table width="806" border="1" style="margin-left: 200px;margin-top: 100px">
        ...
        <tr>
            ...
            <td>
                <label for="textfield2"></label>
                <input name="textfield" type="text" id="textfield2" style="width: 700px" disabled value="<?php if (isset($max)) echo $max; ?>" /></tr>
        </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <label for="textfield2"></label>
                <input name="textfield" type="text" id="textfield2" style="width: 700px" disabled value="<?php  if (isset($min)) echo $min; ?>" /></tr>
        </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <label for="textfield2"></label>
                <input name="textfield" type="text" id="textfield2" style="width: 700px" disabled value="<?php if (isset($tong_so)) echo $tong_so; ?>" /></tr>
        </td>
        </tr>
    </table>
</form>
